...
a.staticslider-button-1 {  color: <?php echo esc_html( $septera_sitetext ) ?>;  border-color: <?php echo esc_html( $septera_contentbackground ) ?>; background-color: <?php echo esc_html( $septera_contentbackground ) ?>;   }
a.staticslider-button-1:hover { color: <?php echo esc_html( $septera_contentbackground ); ?>; }
a.staticslider-button-2 {  border-color: <?php echo esc_html( $septera_contentbackground ) ?>; color: <?php echo esc_html( $septera_contentbackground ); ?>; }
.staticslider-button-2:hover { color: <?php echo esc_html( $septera_sitetext ) ?>; background-color: <?php echo esc_html( $septera_contentbackground ) ?>; }
